...
export default {
  pages: {
    key: 'title',
    data: [
      { title: 'Dashboard', route: { name: 'dashboard-ecommerce' }, icon: 'HomeIcon', isBookmarked: true },
      { title: 'Product', route: { name: 'list-product' }, icon: 'ArchiveIcon', isBookmarked: true },
      { title: 'Purchase', route: { name: 'list-purchase' }, icon: 'ShoppingCartIcon', isBookmarked: true },
      { title: 'Sale', route: { name: 'list-sale' }, icon: 'DollarSignIcon', isBookmarked: true },
      { title: 'Add Product', route: { name: 'add-product' }, icon: 'PlusIcon', isBookmarked: false },
      { title: 'Category', route: { name: 'category-product' }, icon: 'ClipboardIcon', isBookmarked: false },
