  ...
  <b-card-code>
    ...
    >
      ...
      >
        ...
        <!-- Column: Status -->
        <span v-if="props.column.field === 'purchaseStatus'">
          <b-badge :variant="purchaseVariant(props.row.purchaseStatus)">
            {{ props.row.purchaseStatus }}
          </b-badge>
        </span>
...
export default {
  ...
  created() {
    this.$http.get('/app-data/purchases')
